...
class MyProfile extends Component {
    ...
    componentDidMount() {
        ...
        axios.get(piranhaConfig.apiBaseUrl + piranhaConfig.route.my_profile)
    ...
    updateuser = () =>{
        ...
        axios.put(piranhaConfig.apiBaseUrl + piranhaConfig.route.my_profile, user)
            .then(function (response) {
    ...
    changePassword = () =>{
        this.props.history.push('/app/profile/change_password');
    }
    render() {
        const user = this.state.user;
        return (
                        ...
                        <Colxx xxs="9">
                            <Row>
                                ...
                                <Colxx xxs="6" >
                                    ...
                                    >
                                        <IntlMessages id="user.change_password" />
                                    </Button>
