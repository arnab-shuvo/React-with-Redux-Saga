          ...
          <div className="scroll">
            ...
            >
              <Nav vertical className="list-unstyled">
                ...
                <NavItem
                  className={classnames({
                    active: ((this.state.selectedParentMenu == "products" && this.state.viewingParentMenu=="" ) || this.state.viewingParentMenu=="products")
                  })}
                >
                  <NavLink
                    to="/app/layouts"
                    onClick={e => this.openSubMenu(e, "products")}
                  >
        ...
        <div className="sub-menu">
          <div className="scroll">
            ...
            >
              ...
              <Nav
                className={classnames({
                  "d-block": ((this.state.selectedParentMenu == "products" && this.state.viewingParentMenu=="" )|| this.state.viewingParentMenu=="products")
                })}
                data-parent="products"
              >
                <NavItem>
                  <NavLink to="/app/products/product-list">
                    <i className="simple-icon-list" />{" "}
                    <IntlMessages id="menu.products-list" />
                  </NavLink>
                </NavItem>            
              </Nav>              
              <Nav
              ...
              >
                <NavItem>
                  <NavLink to="/app/users">
                    <i className="simple-icon-user" />{" "}
                    <IntlMessages id="menu.users-list" />
                  </NavLink>
                </NavItem>
              </Nav>
            </PerfectScrollbar>
