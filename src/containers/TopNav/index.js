...
class TopNav extends Component {
  ...
  handleLogout = () => {
    ...
    axios.defaults.headers.delete["Authorization"] = session_key;
    let comp_this = this;
    axios.delete(piranhaConfig.apiBaseUrl + piranhaConfig.route.logout)
      .then(function (response) {
        comp_this.props.logoutUser(comp_this.props.history);
      })
  ...
  profile = () =>{
    this.props.history.push('/app/profile/my_profile');
  }
